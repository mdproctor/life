...
| [current-principal-cdi-exclusion.md](current-principal-cdi-exclusion.md) | Exclude competing @Default CurrentPrincipal beans via exclude-types — never rely on selected-alternatives for non-@Alternative beans | application.properties and test/resources/application.properties |
